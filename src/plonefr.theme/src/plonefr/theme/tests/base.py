...
from plonefr.theme.testing import (
    PLONE_MANAGER_NAME,
    TEST_USER_NAME,
    PLONEFR_THEME_SIMPLE as SIMPLE,
    PLONEFR_THEME_FIXTURE as UNIT_TESTING,
    PLONEFR_THEME_INTEGRATION_TESTING as INTEGRATION_TESTING,
    PLONEFR_THEME_FUNCTIONAL_TESTING as FUNCTIONAL_TESTING,
    PLONEFR_THEME_SELENIUM_TESTING as SELENIUM_TESTING,
)
