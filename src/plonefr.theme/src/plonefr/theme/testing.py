...
class PlonefrThemeLayer(PloneSandboxLayer):
    """Layer to setup the theme site"""
    ...
    def setUpZope(self, app, configurationContext):
        """Set up the additional products required for the plonefr site theme.
        ...
        # Load our own theme
        # ----------------------------------------------------
        import plonefr.theme
        self.loadZCML(
            'configure.zcml',
            package=plonefr.theme
        )
    ...
    def setUpPloneSite(self, portal):
        ...
        self.applyProfile(portal, 'plonefr.theme:default')


PLONEFR_THEME_FIXTURE = PlonefrThemeLayer(
    name='PlonefrTheme:Fixture')


class IntegrationTesting(BIntegrationTesting):

    defaultBases = (
        PLONEFR_THEME_FIXTURE,
...
PLONEFR_THEME_INTEGRATION_TESTING = (
    IntegrationTesting(name="PlonefrTheme:Integration")
)
...
PLONEFR_THEME_FUNCTIONAL_TESTING = (
    FunctionalTesting(name="PlonefrTheme:Functional")
)
...
PLONEFR_THEME_SELENIUM_TESTING = (
    SeleniumTesting(name="PlonefrTheme:Selenium")
)
...
PLONEFR_THEME_SIMPLE = SimpleLayer(
    name='PlonefrTheme:Simple'
)
...
class Browser(z2.Browser):  # pragma: no cover
    ...
    def __init__(self, app=None, url=None, headers=None):
        ...
        if not url.startswith('http'):
            host = PLONEFR_THEME_FUNCTIONAL_TESTING['host']
            port = PLONEFR_THEME_FUNCTIONAL_TESTING['port']
