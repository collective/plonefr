==============================================================
BUILDOUT FOR plonefr.theme DOCUMENTATION
==============================================================
...
::
    ...
    cd plonefr.theme
    mkdir workdir
    git clone ssh://git@github.com:orga/project.git plonefr.theme
...
PROJECT Files
~~~~~~~~~~~~~~~~~~~~~~~~
- Think you have the most important sections of this buildout configuration in etc/plonefr.theme.cfg
